...
## Project Structure
    ...
    ├── lupus_fighters_reso_36766  # Django project configurations
...
1. Clone this repo and `cd lupus_fighters_reso_36766`
...
2. Clone this repo and `cd lupus_fighters_reso_36766`
